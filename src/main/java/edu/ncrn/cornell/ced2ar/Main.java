...
* Main class to generated DDI from data file.
* Validated the command line input using Util class.
* If the input is valid, generated ddi using  GenerateDDI class
* 
